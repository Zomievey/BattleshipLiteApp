...
namespace BattleshipLiteLibrary
{
    public static class GameLogic
    {
        ...
        public static bool PlaceShips(PlayerInfoModel model, string location)
        {
            ...
            if (isValidLocation && isSpotOpen)
            {
                model.ShipLocations.Add(new GridSpotModel
                {
                    ...
                    SpotNumber = column,
                    Status = GridSpotStatus.Ship //means there is a ship here
                });

                output = true;
            }
            return output; //it will either place the ship or return false and do nothing
        }
        ...
        {
            bool isActive = false; // at least one ship is not sunk
        ...
        public static int GetShotCount(PlayerInfoModel player)
        {
            ...
            {
                if (shot.Status != GridSpotStatus.Empty) //either taken a shot and hit or missed
                {
                    shotCount += 1;
                }
            }
